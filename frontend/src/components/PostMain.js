    ...
    <div className="border-2 rounded-3xl m-5 border-black">
      <div>
        <div className="text-left ml-3 mt-2">
          <h1 className="text-gray-400 font-bold mb-2">{post.type}</h1>
          <div className="">
            <div className="inline-flex items-center mb-2 font-bold">
              {pinIcon}
              <h2 className="ml-2 font-bold">{post.locationType}</h2>
            </div>
            <h3 className="text-lg fond-semibold">{post.title}</h3>
          </div>
        </div>
